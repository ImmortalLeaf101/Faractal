...
public class AutoClicker extends Module {
    ...
    private final float[] clicks = new float[5];
        ...
        if ((boolean) this.getVal("Break blocks") && this.mcInstance.objectMouseOver != null) {
            ...
            if (pos != null) {
                ...
                if (block != Blocks.air && !(block instanceof BlockLiquid) && (block != null)) {
                    if (!this.held) {
                        KeyBinding.setKeyBindState(this.mcInstance.gameSettings.keyBindAttack.getKeyCode(), true);
                        KeyBinding.onTick(this.mcInstance.gameSettings.keyBindAttack.getKeyCode());
    ...
    private void click() {
        ...
        if (deviation < 1.0 && System.currentTimeMillis() > this.time + (1500 + Random.simpleRandom(0, 250))) {
